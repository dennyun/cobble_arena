...
public final class CobblemonArenaClient {
    ...
    public static void init() {
        ...
        net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents.END_CLIENT_TICK.register(client -> {
            cobblemon.arena.client.ArenaBattleClientState.tick();
        });
    ...
    private static void registerPayloadTypes() {
        ...
        registerS2CPayloadType(
            cobblemon.arena.network.ActiveBattlesUpdatePacket.TYPE,
            cobblemon.arena.network.ActiveBattlesUpdatePacket.CODEC
        );
        registerS2CPayloadType(
            cobblemon.arena.network.ArenaSpectateStatusPacket.TYPE,
            cobblemon.arena.network.ArenaSpectateStatusPacket.CODEC
        );
    ...
    private static void registerReceivers() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(
            ...
            (packet, context) ->
                context
                    .client()
                    .execute(() -> ClientPacketHandler.handleActiveBattlesUpdate(packet))
        );
        ClientPlayNetworking.registerGlobalReceiver(
            cobblemon.arena.network.ArenaSpectateStatusPacket.TYPE,
            (packet, context) ->
                context
                    .client()
                    .execute(() -> ClientPacketHandler.handleSpectateStatus(packet))
        );
    }
}
