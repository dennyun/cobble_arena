        ...
        DAILY_QUEST_POOL = new ArrayList<>(
            List.of(
                new Quest(
                    ...
                    "Jogue 3 partidas (qualquer modo)",
                    "Objetivo: concluir 3 batalhas hoje, em casual ou ranqueada.",
                    3,
                    null,
                ...
                new Quest(
                    "daily_play_5",
                    QuestType.PLAY_MATCHES,
                    "Jogue 5 partidas (qualquer modo)",
                    "Objetivo: concluir 5 batalhas hoje, em qualquer fila.",
                    5,
                    null,
                ...
                new Quest(
                    ...
                    "Venca 2 partidas (qualquer modo)",
                    "Objetivo: vencer 2 batalhas hoje, em casual ou ranqueada.",
                    2,
                    null,
                ...
                new Quest(
                    "daily_win_3",
                    QuestType.WIN_MATCHES,
                    "Venca 3 partidas (qualquer modo)",
                    "Objetivo: vencer 3 batalhas hoje, em qualquer fila.",
                    3,
                    null,
                ...
                new Quest(
                    ...
                    "Venca 1 partida ranqueada",
                    "Objetivo: ganhar 1 batalha na fila ranqueada.",
                    1,
                    null,
                    new QuestReward("100 Tokens de Arena", List.of()),
                    true
                ...
                new Quest(
                    "daily_win_ranked_2",
                    QuestType.WIN_RANKED,
                    "Venca 2 partidas ranqueadas",
                    "Objetivo: ganhar 2 batalhas na fila ranqueada.",
                    2,
                    null,
                ...
                new Quest(
                    ...
                    "Objetivo: concluir 3 batalhas na fila ranqueada.",
                    3,
                    null,
                ...
                new Quest(
                    ...
                    "Objetivo: concluir 3 batalhas na fila rapida.",
                    3,
                    null,
                ...
                new Quest(
                    ...
                    "Faca 2 vitorias seguidas",
                    "Objetivo: conquistar uma sequencia de 2 vitorias consecutivas.",
                    2,
                    null,
                ...
                new Quest(
                    "daily_use_fire",
                    QuestType.USE_TYPE,
                    "Use Pokemon tipo Fogo em 1 partida",
                    "Objetivo: entrar em batalha com pelo menos 1 Pokemon do tipo Fogo no time.",
                    1,
                    "fire",
                ...
                new Quest(
                    "daily_use_water",
                    QuestType.USE_TYPE,
                    "Use Pokemon tipo Agua em 1 partida",
                    "Objetivo: entrar em batalha com pelo menos 1 Pokemon do tipo Agua no time.",
                    1,
                    "water",
                    new QuestReward("60 Tokens de Arena", List.of()),
                    true
                ...
                new Quest(
                    "daily_use_electric",
                    QuestType.USE_TYPE,
                    "Use Pokemon tipo Eletrico em 1 partida",
                    "Objetivo: entrar em batalha com pelo menos 1 Pokemon do tipo Eletrico no time.",
                    1,
                    "electric",
                    new QuestReward("60 Tokens de Arena", List.of()),
                    true
        ...
        WEEKLY_QUEST_POOL = new ArrayList<>(
            List.of(
                new Quest(
                    "weekly_play_15",
                    QuestType.PLAY_MATCHES,
                    "Jogue 15 partidas na semana",
                    "Objetivo semanal: concluir 15 batalhas (qualquer modo).",
                    15,
                    null,
                ...
                new Quest(
                    "weekly_win_10",
                    QuestType.WIN_MATCHES,
                    "Venca 10 partidas na semana",
                    "Objetivo semanal: vencer 10 batalhas em qualquer fila.",
                    10,
                    null,
                ...
                new Quest(
                    "weekly_ranked_5",
                    QuestType.WIN_RANKED,
                    "Venca 5 ranqueadas na semana",
                    "Objetivo semanal: ganhar 5 batalhas ranqueadas.",
                    5,
                    null,
                ...
                new Quest(
                    "weekly_streak_3",
                    QuestType.WIN_STREAK,
                    "Faca 3 vitorias seguidas",
                    "Objetivo semanal: conquistar sequencia de 3 vitorias consecutivas.",
                    3,
                    null,
                ...
                new Quest(
                    ...
                    QuestType.PLAY_RANKED,
                    "Jogue 3 ranqueadas",
                    "Objetivo semanal: concluir 3 batalhas na fila ranqueada.",
                    3,
                    null,
                ...
                new Quest(
                    ...
                    QuestType.WIN_RANKED,
                    "Venca 3 ranqueadas de duplas",
                    "Objetivo semanal: ganhar 3 batalhas ranqueadas em formato doubles.",
                    3,
                    "doubles",
