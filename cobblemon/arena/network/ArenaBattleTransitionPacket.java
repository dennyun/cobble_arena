...
public record ArenaBattleTransitionPacket(
    ...
    > CODEC = PacketCodec.of(
        ...
        (packet, buf) -> {
            ...
            // Write elos (new fields, v3 format)
            buf.writeInt(packet.leftPlayerElo());
            buf.writeInt(packet.rightPlayerElo());
        },
        ...
        buf -> {
            ...
            String battleTypeId = buf.isReadable()
                ...
                : "singles";
            int leftElo = buf.isReadable() ? buf.readInt() : 0;
            int rightElo = buf.isReadable() ? buf.readInt() : 0;
